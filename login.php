...
<div id="loader">
    ...
    <div class="container" style="margin-left: auto;margin-right: auto; margin-top: 100px; margin-bottom:200px; width: 335px;">
        ...
        <form action="actions/login.php" method="post">
                ...
                <br>
                <button class="form-control btn btn-warning hvr-underline-from-center">LOGIN</button>
                <!-- <input class="orange-btn form-control hvr-underline-from-center" type="submit" name="login" value="Login"> -->
        </form>
        <br>
        <p class="text-center text-decoration-none"><a href="register.php" class="text-muted">Create an Account</a></p>
    </div>
